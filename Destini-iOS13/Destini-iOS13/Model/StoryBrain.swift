...
struct StoryBrain{
    ...
    mutating func next(userChoice:Int,Current: inout Int) -> Story{
        
        if userChoice == 1 {
            nextStory = storys[Current].choice1Destination
            Current = storys[Current].choice1Destination
        }
        else{
            nextStory = storys[Current].choice2Destination
            Current = storys[Current].choice2Destination
        }
        return storys[nextStory]
    }
